...
x,y = fn_sin(1,1)
y,z = fn_exp(1,x=y)
write_figure( "sine_comp_exp", x, z, xlim, ylim, pure )

x = np.arange(-1, 1, 0.01)
x,y = fn_exp(1,x=x)
y,z = fn_sin(1,20,x=y)
write_figure( "exp_comp_sine", x, z, xlim, ylim, pure )

x = np.arange(-1, 1, 0.01)
x,y = fn_exp(1,x=x)
y,z1 = fn_sin(1,20,x=y)
x,z2 = fn_poly([0,0.1,0.3,0.5],x=x)
write_figure( "exp_comp_sine_on_poly", x, z1+z2, xlim, ylim, pure )

x,y = fn_sin(1,1)
y,z = fn_ln(x=y)
write_figure( "sin_comp_ln", x, z, xlim, ylim, pure )
